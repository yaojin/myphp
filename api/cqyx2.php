...
$channel = empty($_GET['id']) ? "CCTV1HD" : trim($_GET['id']);
$jishu = 1;
...
if ($channel == "quanbu") {
    ...
    foreach ($channelIDArr['data']['results'] as $channelArr) {
        echo $jishu . "---" . $channelArr['channelName'] . "," . "https://xxx.xxx.xxx/cbn.php?id=" . $channelArr['channelId'] . "</br>";
        $jishu++;
    }
    echo "121---CCTV5P高清,https://xxx.xxx.xxx/cbn.php?id=cctv5SportHD";
    exit();
} else {
